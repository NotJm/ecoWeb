        ...
        <footer className="mt-5 bg-eggs text-dark">
            <div className="container py-4">
                <div className="row">
                    ...
                    <div className="col-md-4 text-center">
                        <h5>Contacto</h5>
                        <p>Email: info@eco-nido.com</p>
                        <p>Teléfono: +52 771 525 6870</p>
                    </div>
                    <div className="col-md-4 text-center">
                        <h5>Localidad: Huejutla de Reyes</h5>
                        <p>Calle: Adolfo Lopez</p>
                        <p>Colonia: Juarez</p>
                        <p>Ciudad Huejutla</p>
                    </div>
                    <div className="col-md-4 text-center">
                ...
                <p className="mb-0 text-center">
                    © {new Date().getFullYear()} Eco-Nido. Todos los derechos reservados.
                </p>
            </div>
        </footer>
    );
